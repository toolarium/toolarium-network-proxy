/*
 * BasicAuthenticationHttpHandler.java
 *
 * Copyright by toolarium, all rights reserved.
 */
package com.github.toolarium.network.proxy.handler.auth;
...
public final class BasicAuthenticationHttpHandler {
     ...
     * @return the handler
     */
    public static HttpHandler addHandler(final INetworkProxyConfiguration configuration,
